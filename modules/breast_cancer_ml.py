...
COMPONENTS = "breast_cancer_components.py"
...
PIPELINE = "breast_cancer_pipeline.py"
...
TRANSFORM_MODULE_FILE = "breast_cancer_transform.py"
...
TRAINER = "breast_cancer_trainer.py"
...
from modules.breast_cancer_pipeline import init_local_pipeline
...
DATA_ROOT = 'data'
TRANSFORM_MODULE_FILE = 'modules/breast_cancer_transform.py'
TUNER_MODULE_FILE = 'modules/tuner_module_file.py'
TRAINER_MODULE_FILE = 'modules/breast_cancer_trainer.py'
...
get_ipython().system('pylint breast_cancer_components.py')


# In[ ]:


get_ipython().system('autopep8 --in-place --aggressive --aggressive breast_cancer_components.py')
...
get_ipython().system('pylint breast_cancer_pipeline.py')


# In[ ]:


get_ipython().system('autopep8 --in-place --aggressive --aggressive breast_cancer_pipeline.py')
...
get_ipython().system('pylint breast_cancer_transform.py')


# In[ ]:


get_ipython().system('autopep8 --in-place --aggressive --aggressive breast_cancer_transform.py')
...
get_ipython().system('pylint breast_cancer_trainer.py')


# In[ ]:


get_ipython().system('autopep8 --in-place --aggressive --aggressive breast_cancer_trainer.py')
